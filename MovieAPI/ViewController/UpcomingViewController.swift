...
class UpcomingViewController: UIViewController {
    ...
    lazy var collectionView: UICollectionView = {
        ...
        view.translatesAutoresizingMaskIntoConstraints = false
        view.register(UpcomingCollectionViewCell.self, forCellWithReuseIdentifier: "UpcomingCollectionViewCell")
    ...
    func setUpSubviews(){
        ...
        PopularListMovieLoader().getListMovies(listType: .upcoming) { result in
            switch result {
